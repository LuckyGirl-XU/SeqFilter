...
def get_link_prediction_args(is_evaluation: bool = False):
    ...
    parser.add_argument('--model_name', type=str, default='SeqFilter', help='name of the model, note that EdgeBank is only applicable for evaluation',
                        choices=['JODIE', 'DyRep', 'TGAT', 'TGN', 'CAWN', 'EdgeBank', 'TCL', 'GraphMixer', 'DyGFormer', 'SeqFilter'])
    ...
    parser.add_argument('--energy_threshold', type=float, default=0.3, help='Tau in frequency-selective structure encoder')
    parser.add_argument('--rhythm_Conv', type=int, default=4, help='Depthwise Convolution')
    parser.add_argument('--structure_Conv', type=int, default=8, help='Standard Convolution')
